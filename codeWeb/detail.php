    ...
    <main class="container mt-5">
        <!-- <h3 class="text-center text-uppercase mb-3 text-primary">CẢM NHẬN VỀ BÀI HÁT</h3> -->
                ...
                <?php 
                  ...
                  $sql = "select hinhanh,tieude, ten_tloai, tomtat,noidung,ten_tgia from baiviet,theloai,tacgia where baiviet.ma_tloai = theloai.ma_tloai and baiviet.ma_tgia = tacgia.ma_tgia and baiviet.tieude ='".$title."'";
